...
public class MyFirstTelegramBot extends MultiSessionTelegramBot {
    ...
    public static final String NAME = "AntroxMaratonBot_bot";
    public static final String TOKEN = "7247327930:AAH6lQ9qgx5noKExYbrKqCvualu01EBGApc";
    ...
    public void onUpdateEventReceived(Update update) {
        ...
        if (getCallbackQueryButtonKey().equals("step_5_btn")){
            ...
            sendTextMessageAsync(STEP_6_TEXT,
                    Map.of("¡Correr x los tejados, grabar con la GoPro! +40 de fama","step_6_btn",
